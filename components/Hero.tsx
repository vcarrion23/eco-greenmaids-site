...
// We removed the 'FadeIn' import so the error will stop
  ...
  return (
    <section className="relative bg-eco-50 min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        {/* THE BUTTONS (Fully working now) */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          
          {/* 1. Book a Clean -> Connects to WhatsApp */}
          <a 
          ...
          {/* 2. View Our Work -> Goes to /services page */}
          <Link 
            href="/services" 
